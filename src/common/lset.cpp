...
int TileSet::Load( File &file, const char *setname ) {
...
int UnitSet::Load( File &file, const char *setname ) {
  int rc = -1;
...
int UnitSet::LoadUnitTypes( File &file ) {
...
int TerrainType::Load( File &file ) {
  tt_type = file.Read16();
...
int TerrainSet::Load( File &file, const char *setname ) {
  int rc = -1;
...
int TerrainSet::LoadTerrainTypes( File &file ) {
...
int UnitType::Load( File &file, const UnitSet *set ) {
