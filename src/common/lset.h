...
public:
  UnitType( void ) {}
  int Load( File &file, const UnitSet *set );
...
public:
  ...
  virtual int Load( File &file, const char *setname );
...
public:
  ...
  int Load( File &file, const char *setname );
...
protected:
  int LoadUnitTypes( File &file );
  int LoadSfx( File &file );
...
protected:
  int LoadTerrainTypes( File &file );
